        ...
        <div class="container main">
          ...
          <div class="break row">
            ...
            <div class="col-lg-3 col-xl-3 col-md-6 col-sm-12">
              <div class="card black" style="height: 100%">
                <div class="card-body" style="height: 100%">
                  <h3 class="card-title">Water Temp</h3>
                  <!-- <h6 class="card-subtitle mb-2 text-muted">Sensor 1</h6> -->
    ...
    <!-- Graphs -->
            <div class="break col-lg-6 col-xl-6 col-md-12 col-sm-12">
              <div class="card black">
                <div class="card-body">
                  <h3 class="card-title">Temperature Record</h3>
            ...
            <div class="break col-lg-6 col-xl-6 col-md-12 col-sm-12">
              <div class="card black">
                <div class="card-body">
                  <h3 class="card-title">Humidity Record</h3>
        ...
        function updateGuage(){
          ...
          $.ajax({
            ...
            success:function(stringData)
            {
              ...
              document.getElementById("volt").innerHTML="13.8 V*";//v+" V";// UNDER REPAIR
            }
          }).responseText;
          $.ajax({
