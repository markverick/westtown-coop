...
<body id="body" class="bg">
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data == "10") {
                                    ...
                                    $("#content").load("php_scripts/launchpanel.php");
                                    $("#perm").load("php_scripts/launchpanelperm.php");
                                    $("#table").load("php_scripts/launchtable.php");
    ...
    <div id="nav" class="menu navbar-default navbar-fixed-top bg-dark">
        ...
        <center>
           <a href='https://www.westtown.edu'> <img style="position: static" src="website_images/logo_graphic.png"> </a>
        </center>
    </div>
    <center>
    ...
    <div id="footer" class="container white footer">
        ...
        <div class="row">
            <div class="break col-lg-4 col-xl-4 col-md-4 col-sm-4">
                <!-- <h6 class="card-subtitle mb-2 text-muted">Sensor 1</h6> -->
                Thanks to: Tom L. Gilbert, Larry J. Dech, Claire W. McLear<br> Creators: Omelet Theeranantachai'18 and Yiheng Xie'18 <br> Project Managers: Maxwell Penders'21 and Lindsey Turner'21 <br> &copy; Copyright 2018 Computer Science 1
            </div>
            <div class="break col-lg-4 col-xl-4 col-md-4 col-sm-4">
                Contacts:<br><a href="mailto:lindsey.turner@westtown.edu">lindsey.turner@westtown.edu</a><br>(215) 694-7556<br><a href="mailto:max.penders@westtown.edu">max.penders@westtown.edu</a><br>(610) 639-1878
            </div>
